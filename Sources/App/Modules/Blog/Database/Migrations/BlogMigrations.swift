    ...
    struct v1: AsyncMigration {
        func prepare(on database: Database) async throws {
            ...
            try await database.schema(BlogPostModel.schema)
                ...
                .foreignKey(BlogPostModel.FieldKeys.v1.categoryId, references: BlogCategoryModel.schema, .id, onDelete: DatabaseSchema.ForeignKeyAction.setNull, onUpdate: .cascade)
